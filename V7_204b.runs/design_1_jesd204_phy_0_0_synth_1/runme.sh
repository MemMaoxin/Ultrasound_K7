...
HD_PWD='D:/6_xianyu/22_jesd_udp/code/V7_204b_1/V7_204b.runs/design_1_jesd204_phy_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_jesd204_phy_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_jesd204_phy_0_0.tcl
