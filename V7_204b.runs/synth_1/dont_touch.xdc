...
# IP: ip/fifo_jesd_2_eth/fifo_jesd_2_eth.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==fifo_jesd_2_eth || ORIG_REF_NAME==fifo_jesd_2_eth} -quiet] -quiet
