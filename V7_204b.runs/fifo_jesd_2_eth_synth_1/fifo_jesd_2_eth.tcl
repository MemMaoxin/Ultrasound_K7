...
OPTRACE "fifo_jesd_2_eth_synth_1" START { ROLLUP_AUTO }
...
synth_design -top fifo_jesd_2_eth -part xc7k325tffg900-2 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix fifo_jesd_2_eth_ fifo_jesd_2_eth.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fifo_jesd_2_eth_stub.v
 lappend ipCachedFiles fifo_jesd_2_eth_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fifo_jesd_2_eth_stub.vhdl
 lappend ipCachedFiles fifo_jesd_2_eth_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fifo_jesd_2_eth_sim_netlist.v
 lappend ipCachedFiles fifo_jesd_2_eth_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fifo_jesd_2_eth_sim_netlist.vhdl
 lappend ipCachedFiles fifo_jesd_2_eth_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp fifo_jesd_2_eth.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips fifo_jesd_2_eth]
 }
...
rename_ref -prefix_all fifo_jesd_2_eth_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef fifo_jesd_2_eth.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "fifo_jesd_2_eth_synth_1_synth_report_utilization_0" "report_utilization -file fifo_jesd_2_eth_utilization_synth.rpt -pb fifo_jesd_2_eth_utilization_synth.pb"
...
OPTRACE "fifo_jesd_2_eth_synth_1" END { }
