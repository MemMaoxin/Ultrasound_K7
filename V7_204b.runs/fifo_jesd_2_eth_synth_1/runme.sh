...
HD_PWD='C:/Users/maoxi/Desktop/CUHKProject/Ultrasonic/Kintex7/Code/V7_204b_2/V7_204b.runs/fifo_jesd_2_eth_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_jesd_2_eth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_jesd_2_eth.tcl
